			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						...
						<section>
									<h3>New Essay</h3>
									<form method="post" action="addEssay.action">
										<div class="row uniform">
											<div class="6u 12u$(xsmall)">
												<input type="text" name="title" id="title" value="" placeholder="Title" />
											</div>
											<div class="6u$ 12u$(xsmall)">
												<input type="text" name="descrption" id="descrption" value="" placeholder="Descrption" />
											</div>
											<div class="12u$">
											...
											-->
											<div class="12u$">
												<textarea name="content" id="content" placeholder="Content" rows="20"></textarea>
											</div>
